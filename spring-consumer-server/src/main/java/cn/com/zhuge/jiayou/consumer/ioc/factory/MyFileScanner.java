 ...
 * 根据类路径扫描指定类
 */
public class MyFileScanner implements Scan{

    private String defaultClassPath = MyFileScanner.class.getResource("/").getPath();
    ...
    public MyFileScanner(String defaultClassPath) {
        this.defaultClassPath = defaultClassPath;
    }
